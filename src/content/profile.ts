...
export const content = {
  pt: {
    ...
    before:
      "Antes disso, na Dremio: contribuidor do Apache Arrow, co-autor do Flight SQL e dos drivers JDBC/ODBC. Formado pela UFABC.",
  ...
  en: {
    ...
    before:
      "Before that, at Dremio: Apache Arrow contributor, co-author of Flight SQL and its JDBC/ODBC drivers. Graduated from UFABC.",
